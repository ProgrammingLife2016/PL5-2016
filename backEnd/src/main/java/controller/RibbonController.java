...
public final class RibbonController {
	...
	public static ArrayList<RibbonNode> getRibbonNodes(int minX, int maxX, int zoomLevel, 
		...
		// RibbonNode ribbonNode = new RibbonNode(strand.getId(),
		// strand.getGenomes());
		// ribbonNode.addStrand(strand);
		// ribbonNode.setX(strand.getId());
		// ribbonNode.setY(strand.getWeight() * 10); //TODO find way to
	...
	/**
	 * Check if an edge should exist between two ribbon nodes, and add it if it
	 * should.
	 *
	 * @param startNode
	 *            The start node.
	...
	/**
	 * Collapse two ribbon nodes.
	 * @param node First node.
	 * @param other Second node.
	 * @return One collapsed node.
	 */
	...
	/**
	 * Collapse ribbon nodes.
	 * @param nodes Ribben nodes to be collapsed.
	 * @return ArrayList with collapsed ribbon nodes.
	 */
	public static ArrayList<RibbonNode> collapseBubbles(ArrayList<RibbonNode> nodes) {
		ArrayList<RibbonNode> collapsed;
		ArrayList<RibbonNode> result;
		do {
