...
public class DataTreeTest {
    ...
    DataTree tree; //test tree.
    DataNode root; //root of the tree;
    DataNode child1; //child of the tree;
    DataNode child2; //child of the tree;
    ArrayList<Genome> genomes; //genomes contained in the tree;
    ...
    public void testFilterNodes() throws Exception {
        ...
        ArrayList<DataNode> testArray=tree.filterNodes(5,5,tree.getDataNodesForGenomes(genomes,1),genomes);
